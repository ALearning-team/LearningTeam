...
namespace DataService.BLL
{
	...
	{
		private readonly DataService.DAL.user dal=new DataService.DAL.user();
		public user()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public DataService.Model.user GetModelByCache(int ID)
		//{
		...
		//		catch{}
		//	}
		//	return (DataService.Model.user)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<DataService.Model.user> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DataService.Model.user> DataTableToList(DataTable dt)
		{
			List<DataService.Model.user> modelList = new List<DataService.Model.user>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DataService.Model.user model;
