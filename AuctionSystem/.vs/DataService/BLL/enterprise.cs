...
namespace DataService.BLL
{
	...
	{
		private readonly DataService.DAL.enterprise dal=new DataService.DAL.enterprise();
		public enterprise()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public DataService.Model.enterprise GetModelByCache(string EID)
		//{
			
		//	string CacheKey = "enterpriseModel-" + EID;
		...
		//		catch{}
		//	}
		//	return (DataService.Model.enterprise)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<DataService.Model.enterprise> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DataService.Model.enterprise> DataTableToList(DataTable dt)
		{
			List<DataService.Model.enterprise> modelList = new List<DataService.Model.enterprise>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DataService.Model.enterprise model;
