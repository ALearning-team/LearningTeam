...
namespace DataService.DAL
{
	...
	public partial class business
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("ID", "business"); 
		}
		...
		public bool Add(DataService.Model.business model)
		{
			...
			strSql.Append("UserName,Abstract,Permissions)");
			strSql.Append(" values (");
			strSql.Append("@UserName,@Abstract,@Permissions)");
			MySqlParameter[] parameters = {
					new MySqlParameter("@UserName", MySqlDbType.VarChar,255),
					new MySqlParameter("@Abstract", MySqlDbType.VarChar,255),
					new MySqlParameter("@Permissions", MySqlDbType.VarChar,255)};
			parameters[0].Value = model.UserName;
			parameters[1].Value = model.Abstract;
			parameters[2].Value = model.Permissions;
		...
		public DataService.Model.business GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,UserName,Abstract,Permissions from business ");
			strSql.Append(" where ID=@ID");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.Int32)
			};
			...
			DataService.Model.business model=new DataService.Model.business();
		...
		/// 得到一个对象实体
		/// </summary>
		public DataService.Model.business DataRowToModel(DataRow row)
		{
			DataService.Model.business model=new DataService.Model.business();
			if (row != null)
			{
				...
				{
					model.Permissions=row["Permissions"].ToString();
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,UserName,Abstract,Permissions ");
